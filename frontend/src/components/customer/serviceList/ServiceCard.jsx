...
//     <div
//       className="mt-5 flex cursor-pointer flex-col overflow-hidden rounded-lg bg-white transition-shadow duration-300 ease-in-out md:flex-row"
//       onClick={handleCardClick}
//     >
//       <div className="flex w-full flex-shrink-0 bg-[#fff] md:w-[45%]">
...
//           <div className="flex flex-col gap-0.5 bg-[#fff] py-0 px-1.5">
