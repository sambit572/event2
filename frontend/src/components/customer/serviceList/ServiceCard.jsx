...
alt="Service preview"
className={`h-full w-full object-cover transition-all duration-300 ${!isVendorAvailable ? 'grayscale brightness-50' : ''}`}
/>
{!isVendorAvailable && (
...
<p className="text-sm font-bold text-red-600">OUT OF SERVICE</p>
