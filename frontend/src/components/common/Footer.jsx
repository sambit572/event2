          ...
          <div>
            ...
            <a href="mailto:Support@eventsbridge.com" target="_blank" rel="noopener noreferrer">
              <p className="hover:text-[#ffc107]">
                <img src="/gmail.png" alt="Email" className="icon" /> Support@eventsbridge.com
              </p>
            </a>
            <p className="hover:text-[#ffc107] cursor-pointer" onClick={() => navigate("/help-Center")}> 
              <img src="/phone-call.png" alt="Phone" className="icon" /> 123-456-7890
            </p>
            <p className="hover:text-[#ffc107] cursor-pointer" onClick={() => navigate("/help-Center")}> 
              <img src="/placeholder.png" alt="Location" className="icon" /> Bhubaneswar, Odisha
            </p>
          </div>
          <div>
            <h4>Quick Links</h4>
          ...
          <div className="footer-mobile-grid">
            ...
            <div className="footer-mobile-column">
              <div className="footer-dropdown">
                <h4 onClick={() => toggleSection("contact")}>Contact Us
                  <img src={openSections.contact ? "/up-arrow.png" : "/down.png"} className="dropdown-icon" alt="toggle" />
                </h4>
                <div className={`footer-dropdown-content ${openSections.contact ? "show" : ""}`}>
                  <p><img src="/gmail.png" className="icon" alt="" /> Support@eventsbridge.com</p>
                  <p><img src="/phone-call.png" className="icon" alt="" /> 123-456-7890</p>
                  <p><img src="/placeholder.png" className="icon" alt="" /> Bhubaneswar, Odisha</p>
                </div>
              </div>

              <div className="footer-dropdown">
                <h4 onClick={() => toggleSection("company")}>Company
                  <img src={openSections.company ? "/up-arrow.png" : "/down.png"} className="dropdown-icon" alt="toggle" />
                </h4>
            ...
            <div className="footer-mobile-column">
              <div className="footer-dropdown">
                <h4 onClick={() => toggleSection("quick")}>Quick Links
                  <img src={openSections.quick ? "/up-arrow.png" : "/down.png"} className="dropdown-icon" alt="toggle" />
                </h4>
              ...
              <div className="footer-dropdown">
                <h4 onClick={() => toggleSection("privacy")}>Privacy Policy
                  <img src={openSections.privacy ? "/up-arrow.png" : "/down.png"} className="dropdown-icon" alt="toggle" />
                </h4>
