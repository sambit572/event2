            ...
            <li>
              ...
              <ol className="list-decimal list-inside space-y-3 text-gray-600 leading-relaxed pl-6">
                <li>
                  ...
                  will try to find a replacement vendor of equivalent quality at
                  the originally negotiated price, subject to availability.
                </li>
                <li>
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed pl-6">
                ...
                <div id="3.1.2">
                  <p>
                    ...
                    Vendors may upload videos, images, or other content ("Vendor
                    Content") to the platform. With the vendor’s consent, such
                    Vendor Content may be used by the platform for marketing,
                    promotional, and advertising purposes across our website,
                    social media, and other communication channels. Each Vendor
                    Content will clearly identify the vendor and their
                    association with the platform, ensuring mutual promotion and
                    recognition.
                  </p>
                  ...
                  <ul className="list-disc list-inside space-y-2 mt-2 ml-4">
                    <li>
                      Vendors must ensure their content does not infringe on the
                      intellectual property, privacy, or rights of third
                      parties.
                    </li>
                    <li>
            ...
            <li>
              ...
              <ol className="list-decimal list-inside space-y-3 text-gray-600 leading-relaxed pl-6">
                ...
                <li>
                  ...
                  payment gateway charges). The penalty will be deducted from
                  the vendor's next successful booking. Verified natural
