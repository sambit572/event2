  ...
  return (
    <div className="tc-container">
      <div className="tc-card">
        ...
        <p className="tc-text">
          Our platform connects Vendors offering services with Customers seeking
          to purchase or book these offerings. By accessing and using our
        ...
        <p className="tc-text">
          ...
          pricing, availability, and any applicable terms of sale. Vendors must
          ensure that all listings comply with applicable Indian laws, including
          but not limited to the <strong>Consumer Protection Act, 2019</strong>,{" "}
          ...
          . Vendors are solely accountable for the quality, safety, and legality
          of the services they offer and for obtaining all required licenses or
          permits for their operations. Any false or misleading information,
          counterfeit services, or prohibited content, or any kind of violence
          in the time period of providing services which can be considered as
          crime according to police and Indian law, will result in suspension or
          termination of the vendor’s account without prior notice.
        </p>

        <h3 className="tc-subheading">For Customers:</h3>
        <p className="tc-text">
          Customers are responsible for reviewing all service details, pricing,
          and policies before making a purchase or booking. Advance payments
          must be made through the platform’s secure payment channels, and
          customers must provide accurate contact and event-related information.
          Customers agree to use services in compliance with applicable laws,
          including <strong>The Indian Contract Act, 1872</strong>,{" "}
          ...
          , as well as any local regulations relating to event permissions (such
          as fire safety, noise restrictions, and alcohol licenses). Refunds,
          cancellations, and rescheduling will be governed by the respective
          Vendor’s policy as stated on their service listing, subject to the{" "}
          <strong>Consumer Protection Act, 2019</strong>.
        </p>
        ...
        <p className="tc-text">
          ...
          mediate disputes at our sole discretion in accordance with our dispute
          resolution process and in compliance with the{" "}
        ...
        <p className="tc-text">
          ...
          governing event management, online transactions, and content sharing.
        ...
        <ul className="tc-list">
          ...
          <li>
            <strong>Payment & Settlement Systems Act, 2007</strong> – Regulates
            secure and legal payment processing for online transactions.
          </li>
          <li>
            <strong>Arbitration and Conciliation Act, 1996</strong> – Provides a
            framework for resolving disputes through arbitration instead of
            court proceedings.
          </li>
          <li>
          ...
          <li>
            <strong>FSSAI Regulations</strong> – Applicable to vendors providing
            catering or food-related services, ensuring hygiene and safety
            standards.
          </li>
          <li>
            <strong>Shops and Establishments Acts</strong> – Compliance with
            respective state-level labor laws, operational timings, and employee
            welfare rules.
          </li>
          <li>
            <strong>
            ...
            – Restrictions on permissible sound levels during events to prevent
            disturbances.
          </li>
          <li>
            <strong>Copyright Act, 1957</strong> – Protects against unauthorized
            use of copyrighted materials like music, photographs, and event
            designs.
          </li>
          <li>
