    ...
    <div>
      ...
      <div className="aboutus-container">
        ...
        <div className="aboutus-right">
          ...
          <p>
            Our Platform-as-a-service (PaaS) Company empowers vendors to
            effortlessly list their services while enabling customers to
            seamlessly discover and book them. Whether you're a service provider
            looking for a streamlined way to manage bookings or a customer
            searching for reliable services, our platform bridges the gap with
            efficiency and ease.
          </p>
      ...
      <div className="aboutus-container reverse">
        <div className="aboutus-right">
          ...
          <p>
            Our intuitive platform and smart discovery system ensure vendors
            gain visibility, while customers enjoy hassle-free event planning.
            Whether it's a wedding, corporate event, or party—our platform
