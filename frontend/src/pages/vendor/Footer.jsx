      ...
      <footer className="footer-enhanced">
        <div className="footer-top">
          ...
          <div className="app-buttons">
            <img src="/AppStore.png" alt="Google Play" />
            <img src="/PlayStore.png" alt="App Store" />
          </div>
        </div>
        ...
        <div className="footer-columns-wrapper">
          <div className="footer-columns">
            <div>
              ...
              <p><img src="/emailicon.png" alt="Email icon" className="icon" /> Email@Example.Com</p>
              <p><img src="/phone.png" alt="Phone icon" className="icon" />+919854372701 /34567</p>
              ...
              <div className="social-media">
                ...
                <img src="/emailicon.png" alt="Gmail" className="social-icon" />
       ...
       {/*  <div className="payment-icons">
            ...
            <img src="/Net Banking.png" alt="NetBanking" />
        ...
        <div className="footer-bottom">
          ...
          <div><p>©️ Copyright 2025 EventsBridge. All Rights Reserved.</p></div>
