...
export default function VendorPayment() {
  ...
  return (
    <div className="vendor-payment-page">
      {showPopup && <div className="popup-message">Please fill all required fields!</div>}
      ...
      <div className="payment-box">
        ...
        <label>
          ...
          <input type="text" name="name" value={formData.name} onChange={handleChange} placeholder="Enter account name" />
        </label>
        ...
        <label>
          ...
          <input type="text" name="branchName" value={formData.branchName} onChange={handleChange} placeholder="Enter bank branch name" />
        </label>
        ...
        <div className="input-wrapper">
          ...
          <div className="input-with-icon">
            ...
            <img src="/question.png" alt="info" title="You can find this on your cheque or bank passbook." />
          </div>
        </div>

        <label>
          GSTIN (Optional)
          <input type="text" name="gstin" value={formData.gstin} onChange={handleChange} placeholder="Enter GSTIN if available" />
        </label>

        <div className="upi-wrapper">
          <label>
            UPI Id (Optional)
            <input type="text" name="upi" value={formData.upi} onChange={handleChange} placeholder="Enter UPI Id" />
          </label>
          <div className="upi-input-with-icon">
            <img src="/question.png" alt="info" title="You can find your UPI ID using your banking app or UPI-enabled apps like PhonePe, Google Pay, Paytm, etc." />
          </div>
        </div>

        <div className="pan-upload-box">
          <div className="title">Upload PAN Card <span className="required-icon">*</span></div>
