                            ...
                            <div className="bg-stone-100/65 backdrop-blur-md rounded-xl shadow-lg p-8">
                                <div className="flex flex-col gap-4">
                                    <div className="text-left">
                                        ...
                                        <p className="text-gray-600 mt-1">Welcome! Please fill in the details to register.</p>
                                    </div>
                                    
                                    {/* Error message */}
                                    {error && (
                                        <div className="bg-red-100/90 border-l-4 border-red-500 text-red-700 p-4 rounded-md backdrop-blur-sm" role="alert">
                                            <p>{error}</p>
                                        </div>
                                    )}
