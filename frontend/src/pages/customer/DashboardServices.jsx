  ...
  return (
    <div className="dashboard-container">
      ...
      <aside className={`sidebar ${sidebarOpen ? "open" : ""}`}>
        <div className="cancel-icon" onClick={() => setSidebarOpen(false)}>
          <FaTimes />
        </div>
        <ul>
          <li>Dashboard</li>
        ...
        {activeTab === "services" ? (
          <section className="service-card">
            ...
            <div className="main-image-and-buttons">
              <img src={selectedImage} alt="DJ Service" className="main-image" />
            ...
            <div className="right-section">
              {isEditing ? (
                <form className="edit-form">
                  ...
                  <input type="text" name="priceRange" value={formData.priceRange} onChange={handleChange} placeholder="Price Range" />
                ...
                <div className="details">
                  ...
                  <p className='c'><strong>Category: </strong>{formData.category}</p>
                  <p className='d'><strong>Duration: </strong>{formData.duration}</p>
                  <p className='des'><strong>Description: </strong></p>
                  <p>{formData.description}</p>
                  <p className='u'><strong>User Reviews: </strong>{formData.userReviews}</p>
                </div>
              )}
            </div>
          </section>
          ...
          <section className="booking-card">
            ...
            <p>This section will show all the bookings made for your services.</p>
          </section>
        )}
      </main>
    </div>
